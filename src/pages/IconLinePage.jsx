  ...
  return (
    <div className={`icon-styles-page${hoverFx ? " icon-styles-page--hover-fx" : ""}`}>
      <header className="page-header">
        <div>
          <h1>Line & fill icons</h1>
          <p>Soft stroke, fill, duotone, clay, and crystal SoftIcon languages for toolbars, nav, and dense UI chrome.</p>
        </div>

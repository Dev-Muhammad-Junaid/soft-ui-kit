  ...
  return (
    <div className={`icon-styles-page${hoverFx ? " icon-styles-page--hover-fx" : ""}`}>
      <header className="page-header">
        <div>
          <h1>Glass & depth icons</h1>
          <p>Frosted plate, isometric tilt, glow core, acrylic slab, and prism SoftIcon modes inspired by glass mood refs.</p>
        </div>
      ...
      <Card className="icon-styles-refs glass sheen" title="Reference mood" description="Glass & depth icons mood boards">
        <div className="icon-styles-refs__grid">
          {[
            { src: `${import.meta.env.BASE_URL}icon-refs/glass-a.png`, label: "Frosted glass A" },
            { src: `${import.meta.env.BASE_URL}icon-refs/glass-b.png`, label: "Frosted glass B" },
            { src: `${import.meta.env.BASE_URL}icon-refs/glass-c.png`, label: "Frosted glass C" }
          ].map((img) => (

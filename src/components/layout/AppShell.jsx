...
const LINKS = [
  ...
  { to: "/icon-styles", label: "Icon styles", icon: Palette },
  { to: "/icon-styles/line", label: "Icons · Line", icon: Palette },
  { to: "/icon-styles/glass", label: "Icons · Glass", icon: Sparkles },
  { to: "/icon-styles/chrome", label: "Icons · Chrome", icon: Wand2 },
  { to: "/icon-styles/frosted", label: "Icons · Frosted", icon: Boxes },
  { to: "/icon-styles/glassy-mix", label: "Icons · Glassy mix", icon: Sparkles },
